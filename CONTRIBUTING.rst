...
or Miniconda_::
    ...
    conda create -n arbiterd python=3 six virtualenv pytest pytest-cov
    conda activate arbiterd
...
.. _repository: https://github.com/<USERNAME>/arbiterd
.. _issue tracker: https://github.com/<USERNAME>/arbiterd/issues
.. <-- end -->
