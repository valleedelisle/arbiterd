...
Welcome to ``arbiterd`` contributor's guide.
...
If you experience bugs or general issues with ``arbiterd``, please have a look
...
You can help improve ``arbiterd`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``arbiterd`` documentation uses Sphinx_ as its main documentation compiler.
This means that the docs are kept in the same repository as the project code, and
that any documentation update is done in the same way as code contribution.
all docs are in reStructuredText_ format

   .. tip::
      Please notice that the `GitHub web interface`_ provides a quick way of
      propose changes in ``arbiterd``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/arbiterd.git
    cd arbiterd
...
#. Install |pre-commit|_::
   ...
   ``arbiterd`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/SeanMooney/arbiterd
.. _issue tracker: https://github.com/SeanMooney/arbiterd/issues
.. <-- end -->
